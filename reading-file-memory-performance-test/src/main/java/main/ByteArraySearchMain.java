...
import thread.ByteArraySearch;
import thread.MemoryObserver;

public class ByteArraySearchMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < threadCount * 5; i++) {
            ...
            byteArraySearch.setFilePath(filePath);
            executorService.execute(byteArraySearch);
        }
        ...
        if(args.length >= 2) {
            try {
                threadCount = Integer.parseInt(args[1]);
                 ...
                 System.out.println("args[1] is threadCount. should be integer.");
            }
        }
    }
